...
type NextUI =
    ...
    static member inline NavbarContent(xs: ReactElement list) : ReactElement = NavbarContent [ prop.children xs ]
    ...
    static member inline NavbarItem(xs: ReactElement list) : ReactElement = NavbarItem [ prop.children xs ]
